...
contract Agro_supply_chain_management
{
    ...
    {
        require(farmer_balance[farmer_id_by_address[msg.sender]] >= _how_much);
    ...
    {
        require(supplier_balance[supplier_id_by_address[msg.sender]] >= _how_much);
        msg.sender.transfer(_how_much);
        return true;
    }
    ...
    {
        require(shop_balance[shop_id_by_address[msg.sender]] >= _how_much);
        msg.sender.transfer(_how_much);
        return true;
    }
